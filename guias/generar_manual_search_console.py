#!/usr/bin/env python3
"""Genera el PDF imprimible de la guía de Search Console + Analytics.
Uso: python3 generar_manual_search_console.py
...
fuentes base de reportlab (Helvetica/Courier) dibujen bien en cualquier impresora.
"""
import os
import re
import html
...
MD = os.path.join(HERE, "Manual_Search_Console_y_Analytics.md")
OUT = os.path.join(HERE, "Manual_Search_Console_y_Analytics.pdf")
...
def build():
    ...
    doc = SimpleDocTemplate(OUT, pagesize=LETTER, topMargin=18 * mm,
                            ...
                            title="Guia Search Console y Analytics - Lopez Sealcoating LLC")
    doc.build(story)
