...
- [x] Subir fotos y videos reales de trabajos a `public/` y conectarlos en "Nuestros Trabajos". _(galería de proyectos, 3 clips y comparación de la misma entrada circular; ver guias/correccion-medios-2026-09-15.md para procedencia y revisión pendiente.)_
